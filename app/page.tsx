...
const basePath = '/cnno-1776321822601';
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft exceptional, artisanal sweet rolls that bring warmth and comfort to our customers, while fostering a culture of quality, creativity, and community in the heart of Kuching, Sarawak.</p>
                </div>
                <div className="space-y-2">
